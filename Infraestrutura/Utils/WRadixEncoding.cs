...
namespace Infraestrutura.Utils
{
    ...
    public class WRadixEncoding
    {
        ...
        readonly WEndianFormat kEndian;
        ...
        public WEndianFormat Endian { get { return kEndian; } }
        ...
        public WRadixEncoding(string digits, WEndianFormat bytesEndian = WEndianFormat.Little, bool includeProceedingZeros = false)
        {
        ...
        public string Encode(byte[] bytes)
        {
            ...
            if (kEndian == WEndianFormat.Little)
                result.Reverse();
